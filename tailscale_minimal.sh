...
echo Auth String = $auth_key_string
...
echo sudo nmcli connection modify "Wired connection 1" ipv4.route-metric 100
sudo nmcli connection modify "Wired connection 1" ipv4.route-metric 100

echo sudo nmcli connection modify "Decentral" ipv4.route-metric 600
sudo nmcli connection modify "Decentral" ipv4.route-metric 600
